...
#      python -m ingest.import_book --ocr-compare path/to/book.pdf [--engine tesseract] [--pages 1,5,9-12]
#      python -m ingest.import_book --commit path/to/book.pdf --slug s --text-source ocr --engine tesseract
# ============================================================================
set -euo pipefail
cd "$(dirname "$0")/ui"
