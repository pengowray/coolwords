...
REM
REM  Binds 127.0.0.1:17575 by default (safe for a same-box Cloudflare tunnel). Port
REM  is >15000 to stay clear of the Windows/Hyper-V reserved dynamic port ranges
REM  (7575 lands inside one and fails to bind with OS error 10013). To expose on the
REM  LAN / for a remote tunnel, set COOLWORDS_BIND=0.0.0.0:17575 before running.
...
set LEPTOS_ENV=PROD
if "%LEPTOS_SITE_ADDR%"=="" set LEPTOS_SITE_ADDR=127.0.0.1:17575
